...
const TdsTimeSeries = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response = await fetch('http://gardenpi.local:3001/csv/tds_readings.csv'); // Adjust the path as necessary
